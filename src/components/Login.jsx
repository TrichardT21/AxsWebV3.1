...
export default function Login() {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center lg:justify-end bg-[#050814] overflow-hidden select-none font-sans w-full p-4 lg:pr-20 xl:pr-32">
      
      {/* Background Video covering everything */}
      <video 
        src={loginVideo}
        autoPlay 
        loop 
      ...
      <div className="absolute inset-0 bg-[#050814]/45 z-0 pointer-events-none"></div>

      {/* BACKGROUND DECORATIONS (Vibrant glows) */}
      <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] rounded-full bg-blue-600/10 blur-[120px] pointer-events-none z-0"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[600px] h-[600px] rounded-full bg-indigo-600/10 blur-[150px] pointer-events-none z-0"></div>
      ...
      <div className="w-full max-w-[420px] z-10 relative">
        <motion.div
          ...
          className="w-full bg-[#0E1326]/60 backdrop-blur-2xl border border-white/10 rounded-3xl p-8 md:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.6)] relative overflow-hidden"
        >
          {/* Subtle line decoration on card */}
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-blue-500/0 via-blue-500/50 to-indigo-500/0"></div>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-[#070B16]/80 border border-white/5 rounded-xl py-3.5 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-white placeholder:text-gray-600 text-sm"
                    />
                  </div>
                </motion.div>
              )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#070B16]/80 border border-white/5 rounded-xl py-3.5 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-white placeholder:text-gray-600 text-sm font-sans"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full bg-[#070B16]/80 border border-white/5 rounded-xl py-3.5 pl-12 pr-12 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-white placeholder:text-gray-600 text-sm font-sans"
                />
                <button
                  type="button"
